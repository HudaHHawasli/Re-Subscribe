...
if(isset($_POST)) {
    ...
    $main_title = get_option('resubscribe-main-title', true);
    $main_text = get_option('resubscribe-main-text', true);
    $footer_box_text = get_option('resubscribe-footer-box-text', true);
}
